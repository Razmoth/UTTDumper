...
namespace UTTD::Unity {
    enum class TransferInstruction {
        None,
    ...
    static inline TransferInstruction operator |(TransferInstruction lhs, TransferInstruction rhs) {
        using T = std::underlying_type_t <TransferInstruction>;
        return static_cast<TransferInstruction>(static_cast<T>(lhs) | static_cast<T>(rhs));
    }
    ...
    static inline TransferInstruction operator ~(TransferInstruction value) {
        using T = std::underlying_type_t <TransferInstruction>;
        return static_cast<TransferInstruction>(~static_cast<T>(value));
    }
